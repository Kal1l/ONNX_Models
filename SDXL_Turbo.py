...
def main():
    ...
    # Load the SDXL Turbo model (downloads only the first time)
    ...
    if torch.cuda.is_available():
        ...
        # CPU fallback (will be slower and more memory-heavy)
        pipe = DiffusionPipeline.from_pretrained(
            MODEL_ID,
    ...
    # SDXL Turbo works with extremely low steps; 1-4 is typical
    num_inference_steps = 2

    # For turbo models, guidance_scale is typically set very low (often 0.0)
    guidance_scale = 0.0
