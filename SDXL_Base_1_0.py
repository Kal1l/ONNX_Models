...
def main():
    ...
    # Load the SDXL Base 1.0 model (downloads only the first time)
    ...
    # SDXL base typically uses more steps than turbo; 20-30 is comum
    num_inference_steps = 25

    # Guidance scale padrão para SDXL costuma ser 5-9
    guidance_scale = 7.0
